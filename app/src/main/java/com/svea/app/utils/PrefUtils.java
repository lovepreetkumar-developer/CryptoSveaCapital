...
public class PrefUtils {
    ...
    private final String SHARED_PREF_NAME = "myapp";
    ...
    public void setUserId( String value) {
        SharedPreferences.Editor editor = _pref.edit();
        editor.putString(KEY.USER_ID, value);
        editor.apply();
    }
    public String  getUserId( ) {
        return _pref.getString(KEY.USER_ID, null);
    }

    public void setUserData(LoginBean data) {
        SharedPreferences.Editor editor = _pref.edit();
        editor.putString(KEY.USER_DATA,new Gson().toJson(data));
        editor.apply();
    }

    public LoginBean getUserData( ) {
        if (_pref != null) {
            String value = _pref.getString(KEY.USER_DATA, null);
            return new Gson().fromJson(value, LoginBean.class);
        }
        return null;
    }
